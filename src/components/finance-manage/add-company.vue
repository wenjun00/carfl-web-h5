...
export default class AddCompany extends Vue {
  ...
  // 日期格式转化
  TimeChange() {
    this.addCompanyModel.licenseBeginTime = FilterService.dateFormat(this.addCompanyModel.licenseBeginTime, 'yyyy-MM-dd')
    this.addCompanyModel.licenseEndTime = FilterService.dateFormat(this.addCompanyModel.licenseEndTime, 'yyyy-MM-dd')
    this.addCompanyModel.legpersonCertificateStime = FilterService.dateFormat(this.addCompanyModel.legpersonCertificateStime, 'yyyy-MM-dd')
    this.addCompanyModel.legpersonCertificateEtime = FilterService.dateFormat(this.addCompanyModel.legpersonCertificateEtime, 'yyyy-MM-dd')
