...
<template>
  <section class="component company-bank-card">
    <i-row style="display:flex;justify-content:space-around">
      <i-col :span="10">
        <div style="width:100%;height:40px;border:1px solid #d6d6d6;line-height:40px;background:#F2F2F2">
          <span style="margin-left:6px;">建设银行</span>
          <div style="float:right"></div>
        </div>
        <div style="text-align:center;border-left:1px solid #d6d6d6;border-right:1px solid #d6d6d6;height:130px;">
          ...
          <p style="color:#666">户名：开呗（上海）汽车租赁有限公司陕西分公司</p>
          <p style="color:#666">省份：陕西</p><span>城市：西安</span>
          <p style="color:#666">开户行：招商银行</p>
          <p style="color:#666">支行名：招商银行西安支行</p>
        </div>
        <div style="border:1px solid #d6d6d6;height:40px;line-height:40px;background: #d6f9fc">
          <span style="margin-left:6px;color:#666">验证状态：</span><span style="color:green">通过</span>
          <span style="float:right;margin-right:6px;color:#666">绑卡日期：2017-12-01</span>
        </div>
      </i-col>
