...
<template>
  <section class="component confirm-gather">
    <i-form :label-width="100">
      <i-row style="background:#F5F5F5">
        ...
        <i-col :span="24" :pull="3" style="margin-top:10px;margin-left:10px">
          <i-form-item>
            <span>备注：</span>
            <i-input type="textarea" v-model="gatherModal.remarks" style="display:inline-block;width:80%;"></i-input>
          </i-form-item>
        </i-col>
      </i-row>
    </i-form>
    ...
    <table border="1" width="840" style="margin-top:10px;text-align:center">
      <tr height="40">
