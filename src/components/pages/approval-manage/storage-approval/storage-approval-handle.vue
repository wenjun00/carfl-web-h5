<template>
  <section class="component storage-approval-handle">
...
<script lang="ts">
  ...
  @Component({})
  export default class StorageApprovalHandle extends Vue {
     ...
     */
    submit() {
      this.dataImpService.manualEnterOrder(this.approvalModel).subscribe(data => {
        this.$message({
          type: 'success',
          message: '提交成功'
        })
