            ...
            <data-grid :labelWidth="100">
                ...
                <data-grid-item label="产品利率" :span="4">
                    <i-form-item prop="productRate">
                        <i-input v-model="formItems.productRate" placeholder="请输入产品利率"></i-input>%/月
                    </i-form-item>
                </data-grid-item>
                ...
                <data-grid-item label="账期类型" :span="12">
                    <i-form-item prop="paymentType">
                        <i-radio-group style="float:left;margin-top:6px;" v-model="formItems.paymentType">
                            <i-radio label="正常账期" style="margin-right:40px;"></i-radio>
                            <i-radio label="固定账期"></i-radio>
                        </i-radio-group>
                        <i-select v-model="formItems.paymentDay">
                ...
                <data-grid-item label="首付款" :span="12">
                    ...
                    <div v-show="initialParamsShow" style="float:left">
                        <i-form-item prop="initialPayment" label="比例">
                            <i-input v-model="formItems.initialPayment" style="width:45%;display:inline-block;margin-left:10px;"></i-input>
                        </i-form-item>
