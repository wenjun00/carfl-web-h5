...
<template>
    <section class="component customer-job-message">
        ...
        <div v-if="jobType === 37">
            ...
            <div>
                <div class="unit-information-title"></div>
                <span class="unit-information-size">单位信息</span>
            </div>
            ...
            <div>
                <div class="unit-information-title"></div>
                <span class="unit-information-size">收入信息</span>
            </div>
        ...
        <div v-if="jobType ===38">
            <div>
                <div class="unit-information-title"></div>
                <span class="unit-information-size">公司信息</span>
            </div>
