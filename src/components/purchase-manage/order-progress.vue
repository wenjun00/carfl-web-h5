<template>
  <div class="component order-progress">
    <i-row class="item-margin-top20">
      ...
      <!--</Steps>-->
      <i-table :columns="progressColumns" :data="progressData" :page="pageService" @page-change="updateData(page)" :height="400" class="item-margin-top20"></i-table>
    </i-row>
  ...
  created() {
    ...
    },
    {
      ...
      render: (h, {
        ...
        return h(
          "span",
          this.$filter.dateFormat(row.operateTime, "yyyy-MM-dd hh:mm:ss")
        );
      }
    },
    {
