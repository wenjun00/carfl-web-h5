      ...
      <i-row type="flex" :gutter="110">
        <i-col>
          <i-form-item label="客户姓名" prop="name">
            <i-input  v-model="blackListModel.name"></i-input>
          </i-form-item>
        </i-col>
        <i-col>
          <i-form-item label="手机号码" prop="telephone">
            <i-input  v-model="blackListModel.telephone"></i-input>
          </i-form-item>
        </i-col>
      </i-row>
      <i-row type="flex" :gutter="110">
        <i-col>
          <i-form-item label="证件类型" prop="certificateType">
            <i-select v-model="blackListModel.certificateType">
        ...
        <i-col>
          <i-form-item label="证件号码" prop="certificateNumber">
            <i-input  v-model="blackListModel.certificateNumber"></i-input>
          </i-form-item>
        </i-col>
      </i-row>
    </i-form>
