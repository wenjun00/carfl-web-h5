...
<template>
    <section class="page my-approval">
        ...
        <i-row class="data-form" v-if="searchOptions">
            <i-input class="data-form-item search-input" v-model="myOrderModel.personalInfo" placeholder="请录入客户姓名\证件号码\手机号查询"></i-input>
            <span>日期：</span>
            <i-date-picker class="data-form-item date-picker" v-model="myOrderModel.startTime" placeholder="起始日期"></i-date-picker>
            ~
            <i-date-picker class="data-form-item date-picker" v-model="myOrderModel.endTime" placeholder="终止日期"></i-date-picker>
            ...
            <i-select class="data-form-item select product-type" placeholder="产品类型" v-model="myOrderModel.productType" clearable>
