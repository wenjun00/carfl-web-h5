...
<template>
  <section class="page face-approval">
    ...
    <i-row class="data-form" v-if="searchOptions">
      ...
      <i-select class="data-form-item select product-type" placeholder="产品类型" v-model="resourcePoolModel.productType"
                clearable>
    ...
    <data-box :id="244" :columns="columns1" :data="faceList" @onPageChange="getFaceApprovalList"
