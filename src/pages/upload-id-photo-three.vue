  ...
  <section class="page uploadIdPhotoThree">
    ...
    <van-row>
      <van-row class="imgList">
        <van-col span="11">
          <van-uploader capture="camera" class="imgSize headPortrait" result-type="dataUrl" :after-read="onRead" accept="image/gif, image/jpeg" multiple>
        ...
        <van-col span="11">
          <van-uploader capture="camera" class="imgSize headPortrait" result-type="dataUrl" :after-read="onReadTwo" accept="image/gif, image/jpeg" multiple>
