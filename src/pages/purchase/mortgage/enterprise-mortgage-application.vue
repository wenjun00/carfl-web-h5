<template>
  <section class="page enterprise-mortgage-application">
    <page-header title="企业抵押贷款申请">
...
export default class EnterpriseMortgageApplication extends Page {
  // 基础数据表单
  private basisModel = {
    cardNumber: "", // 证件号码
    customterName: "", // 企业名称
  ...
  private applicationTabs = [
    ...
    {
      name: "enterprise-customer-info",
      label: "企业资料"
    },
    {
      name: "enterprise-customer-contact",
      label: "企业联系人"
    },
    {
...
.page.enterprise-mortgage-application {
  & > * {
    margin-bottom: 10px;
  }
}
