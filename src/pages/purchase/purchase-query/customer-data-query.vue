...
<template>
    <section class="page customer-data-query">
        ...
        <i-row class="seek-line" v-if="searchOptions">
            ...
            <i-input class="seek-line-input" v-model="ordertransferModel.orderInfo" @on-change="orderInfochange" placeholder="请输入订单编号/客户姓名/证件号码/联系号码查询"></i-input>
            <i-button class="seek-line-button" @click="refreshData">搜索</i-button>
        </i-row>
