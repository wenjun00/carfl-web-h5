...
<template>
  <section class="pageContainer financing-lease-apply specialInput">
    <div class="page">
      ...
      <i-row type="flex">
        <i-col span="18">
          <i-form ref="customer-form" :model="customerModel" :rules="customerRule" :label-width="80" style="margin-top:20px;">
            <i-col span="12">
              <i-form-item label="证件号码" prop="idCard">
                <i-input type="text" v-model="customerModel.idCard" placeholder="请输入证件号码">
                </i-input>
              </i-form-item>
            </i-col>
            <i-col span="12">
            ...
            <i-col span="12">
              <i-form-item label="归属业务员" prop="worker">
                <i-input type="text" v-model="customerModel.worker" placeholder="请输入归属业务员">
                </i-input>
              </i-form-item>
            </i-col>
          </i-form>
