<template>
  <section class="page purchase-common-use">
...
<script lang="ts">
  ...
  export default class PurchaseCommonUse extends Page {
    ...
    created() {
      ...
      this.orderService.getClientSign().subscribe(({
        val
      }) => {
        this.data1 = val;
      });
