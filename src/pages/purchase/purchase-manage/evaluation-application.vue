...
<template>
  <section class="page evaluation-application">
    <span class="form-title">评估申请</span>
    ...
    <i-checkbox style="margin-left:30px;" v-model="receipt.isIncludeDealt">包含已提交</i-checkbox>
    <div style="font-size:16px;cursor:pointer;display:inline-block;color:#3367A7;float:right;margin-right:10px;margin-top:10px;">
      <i-button style="margin-right:10px" class="blueButton" @click="searchReceiptapprove">新建申请</i-button>
