<template>
  <section class="page login-page theme-default">
    ...
    <el-row type="flex" class="full-absolute fullScreen" justify="center" align="middle">
      <el-form ref="login-form" :model="loginModel" :rules="loginRule" label-width="80px" class="login-form" style="background:#fff;position:absolute;right:200px" type="flex" align="middle">
